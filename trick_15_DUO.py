...
images_folder_path = ['/final/datasets/DUO/images/train', 
                      '/final/datasets/DUO/images/val',
                      '/final/datasets/DUO/images/test']
labels_folder_path = ['/final/datasets/DUO/images/train',
                      '/final/datasets/DUO/labels/val',
                      '/final/datasets/DUO/labels/test']
classes = ['starfish','holothurian', 'echinus', 'scallop']
...
if __name__ == '__main__':
    ...
    # remap_yolo_dataset_class(labels_path_list, delete_label=[0, 3]) #删除标签，这一步谨慎操作，操作之前先备份数据集


# image_path_length:6671 label_path_length:1100
# After matching. data_length:1100
# | 1100/1100 [00:09<00:00, 117.92it/s]
# +-------------+------------+--------------+--------------+-------------+
# | Category    | Small (s)  |  Medium (m)  |  Large (l)   | Total (num) |
# +-------------+------------+--------------+--------------+-------------+
# | starfish    | 40 (2.0%)  | 1066 (52.8%) | 914 (45.2%)  |     2020    |
# | holothurian |  2 (0.2%)  | 668 (61.9%)  | 409 (37.9%)  |     1079    |
# | echinus     | 398 (5.5%) | 4364 (60.6%) | 2439 (33.9%) |     7201    |
# | scallop     |  5 (2.3%)  | 118 (54.4%)  |  94 (43.3%)  |     217     |
# | All         | 445 (4.2%) | 6216 (59.1%) | 3856 (36.7%) |    10517    |
# +-------------+------------+--------------+--------------+-------------+