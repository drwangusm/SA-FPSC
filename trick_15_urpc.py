...
images_folder_path = ['/final/datasets/urpc_yolo/images/train', 
                      '/final/datasets/urpc_yolo/images/val',
                      '/final/datasets/urpc_yolo/images/test']
labels_folder_path = ['/final/datasets/urpc_yolo/images/train',
                      '/final/datasets/urpc_yolo/labels/val',
                      '/final/datasets/urpc_yolo/labels/test']
