...
if __name__ == '__main__':
    model = YOLO('/final/YOLO-SA-FPSC/runs/train/yolov10n-SOEP-ADown-FPSC/weights/best.pt') # select your model.pt path
    model.predict(source='/final/datasets/DUO/images/test',
                  imgsz=640,
                  project='runs/detect/UDO',
                  name='SA-FPSC',
                  save=True,
                  # conf=0.2,
                  # iou=0.7,
