...
if __name__ == '__main__':
    model = YOLO('/final/YOLOv13-20250624/runs/train/URPC/yolov10n-SOEP-ADown-FPSC/weights/best.pt') # select your model.pt path
    model.predict(source='/final/datasets/urpc_yolo/images/test',
                  imgsz=640,
                  project='runs/detect/URPC',
