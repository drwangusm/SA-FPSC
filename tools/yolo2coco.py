...
# EX :python tools/yolo2coco.py --image_path /final/datasets/WUDD/images/train --label_path /final/datasets/WUDD/labels/train --save_path /final/datasets/WUDD/annotations/train.json
