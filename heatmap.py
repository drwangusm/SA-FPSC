...
def get_params():
    params = {
        'weight': '/final/REODNet/runs/train/DUO/yolov10n-SOEP-ADown-FPSC/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        ...
        'renormalize': False # 需要把热力图限制在框内请设置为TrueR
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'/final/datasets/DUO/images/val', 'heatmap_results/DUO/yolov10n-SOEP-ADown-FPSC')