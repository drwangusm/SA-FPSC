...
images_folder_path = ['/final/datasets/WUDD/images/train', 
                      '/final/datasets/WUDD/images/val',
                      '/final/datasets/WUDD/images/test']
labels_folder_path = ['/final/datasets/WUDD/images/train',
                      '/final/datasets/WUDD/labels/val',
                      '/final/datasets/WUDD/labels/test']
classes = ['scallop','seacucumber', 'seaurchin']
...
# image_path_length:2763 label_path_length:456
# After matching. data_length:456
# | 456/456 [00:02<00:00, 172.52it/s]
# +-------------+------------+--------------+--------------+-------------+
# | Category    | Small (s)  |  Medium (m)  |  Large (l)   | Total (num) |
# +-------------+------------+--------------+--------------+-------------+
# | scallop     | 29 (50.9%) |  27 (47.4%)  |   1 (1.8%)   |      57     |
# | seacucumber |  2 (0.8%)  | 206 (79.8%)  |  50 (19.4%)  |     258     |
# | seaurchin   | 115 (3.9%) | 1693 (57.6%) | 1132 (38.5%) |     2940    |
# | All         | 146 (4.5%) | 1926 (59.2%) | 1183 (36.3%) |     3255    |
# +-------------+------------+--------------+--------------+-------------+